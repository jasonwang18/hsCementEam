...
public class SearchEntityActivity extends BaseRefreshRecyclerActivity<CommonSearchEntity> implements BaseSearchContract.View {
    ...
    protected void onInit() {
        ...
        //如果用户并没有传入COMMON_SEARCH_MODE时，则检测用户使用使用了IS_AREAl类型的方式指定搜索模式
        //如果也没有，那就设置默认搜索模式为人员搜索
        searchMode = getIntent().getStringExtra(Constant.IntentKey.COMMON_SAERCH_MODE);
        ...
        questCode = isSystemCode ? Constant.IntentKey.IS_ENTITY_CODE :
